...
fn decompilation_includes_call_graph_syscalls() {
    ...
    let decompilation = Decompiler::new()
        .decompile_bytes_with_manifest(&aef_bytes, None, OutputFormat::Pseudocode)
...
fn call_graph_resolves_relative_call_from_opcode_offset() {
    // Atipicial VM relative call offsets are resolved from opcode position.
...
fn decompilation_includes_call_graph_method_tokens() {
    ...
    let aef_bytes = build_aef_with_single_token(&script, hash, "transfer", 2, true, 0x0F);
    let decompilation = Decompiler::new()
        .decompile_bytes_with_manifest(&aef_bytes, None, OutputFormat::Pseudocode)
        .expect("decompile succeeds");
...
fn decompilation_includes_indirect_calls() {
    ...
    let hash = [0x42u8; 20];
    let aef_bytes = build_aef_with_single_token(&script, hash, "stub", 0, false, 0x0F);
    let decompilation = Decompiler::new()
        .decompile_bytes_with_manifest(&aef_bytes, None, OutputFormat::Pseudocode)
        .expect("decompile succeeds");
