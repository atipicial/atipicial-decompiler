...
fn csharpize_nested_helper_calls_in_cast_path_helpers() {
    // pow/left/right/substr take the int-cast argument path; nested ATC helper
...
fn csharp_escapes_control_chars_in_pushdata_string_literal() {
    ...
    let aef_bytes = build_aef(&[0x0C, 0x03, b'a', b'\n', b'b', 0x40]);
...
fn csharp_non_void_method_with_empty_body_throws_not_implemented() {
    ...
    let aef_bytes = build_aef(&[0x57, 0x00, 0x00, 0x11, 0x12, 0x9E, 0x40, 0x20, 0x40]);
