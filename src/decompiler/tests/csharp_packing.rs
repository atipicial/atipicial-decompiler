...
fn csharp_constant_pack_is_structured_while_trace_mode_selects_legacy() {
    let pack_aef = build_aef(&[0x12, 0x11, 0x12, 0xC0, 0x40]);
    let pack = render_csharp_with_coverage(&pack_aef, None, true, false, true);
    assert_eq!(
        pack.coverage
    ...
    let traced = render_csharp_with_coverage(&aef, Some(manifest), true, true, true);
    assert_eq!(
        traced
            .coverage
            .method(6, "helper")
...
fn csharp_structures_pack_families_and_constant_unpack() {
    ...
    for (script, expected) in cases {
        let rendered = render_csharp_with_coverage(&build_aef(&script), None, true, false, true);
...
fn csharp_type_tag_operands_use_structured_renderer() {
    let cases = [
        (
            ...
            "__AtipicialDecompilerConvertInteger(1)",
        ),
        (
            "IsTypeTag",
            crate::instruction::OpCode::Istype,
            "__AtipicialDecompilerIsTypeInteger(1)",
        ),
        (
            "NewArrayTag",
    ...
    for (contract_name, opcode, expected) in cases {
        ...
        let rendered =
            render_csharp_with_coverage(&build_aef(&script), Some(manifest), true, false, true);
        ...
        if matches!(
            ...
            let helper = match opcode {
                crate::instruction::OpCode::Convert => {
                    "[global::Atipicial.SmartContract.Framework.Attributes.OpCode(global::Atipicial.SmartContract.Framework.OpCode.CONVERT, \"21\")]\n        private static extern BigInteger __AtipicialDecompilerConvertInteger(object value);"
                }
                crate::instruction::OpCode::Istype => {
                    "[global::Atipicial.SmartContract.Framework.Attributes.OpCode(global::Atipicial.SmartContract.Framework.OpCode.ISTYPE, \"21\")]\n        private static extern bool __AtipicialDecompilerIsTypeInteger(object value);"
                }
...
fn csharp_type_tag_helper_avoids_contract_member_collisions() {
    ...
    let manifest = ContractManifest::from_json_str(
        r#"{
            ...
            "abi": { "methods": [{
                "name": "__AtipicialDecompilerConvertInteger",
                "parameters": [],
                "returntype": "Any",
                "offset": 0
            }] }
    ...
    assert!(
        rendered.source.contains(
            "private static extern BigInteger __AtipicialDecompilerConvertInteger_1(object value);"
        ),
    ...
    assert!(
        rendered
            .source
            .contains("__AtipicialDecompilerConvertInteger_1(1)"),
...
fn csharp_unpack_packstruct_helper_preserves_opcode_order_and_avoids_collisions() {
    ...
    let manifest = ContractManifest::from_json_str(
        r#"{
            ...
            "abi": { "methods": [{
                "name": "__AtipicialDecompilerUnpackPackStruct",
                "parameters": [],
                "returntype": "Any",
                "offset": 0
            }] }
    ...
    let helper = "[global::Atipicial.SmartContract.Framework.Attributes.OpCode(global::Atipicial.SmartContract.Framework.OpCode.UNPACK)]\n        [global::Atipicial.SmartContract.Framework.Attributes.OpCode(global::Atipicial.SmartContract.Framework.OpCode.PACKSTRUCT)]\n        private static extern object[] __AtipicialDecompilerUnpackPackStruct_1(object value);";
    assert!(
        rendered.source.contains(helper),
    ...
    assert!(
        rendered
            .source
            .contains("__AtipicialDecompilerUnpackPackStruct_1(1)"),
...
fn csharp_bare_throw_helper_preserves_the_opcode_and_avoids_collisions() {
    ...
    let manifest = ContractManifest::from_json_str(
        r#"{
            ...
            "abi": { "methods": [{
                "name": "__AtipicialDecompilerBareThrow",
                "parameters": [],
                "returntype": "Void",
                "offset": 0
            }] }
    ...
    assert!(
        rendered.source.contains(
            "[global::Atipicial.SmartContract.Framework.Attributes.OpCode(global::Atipicial.SmartContract.Framework.OpCode.THROW)]\n        private static extern void __AtipicialDecompilerBareThrow_1();"
        ),
        "bare-throw helper must preserve the opcode and avoid ABI member names:\n{}",
        rendered.source
    );
    assert!(
        rendered.source.contains("__AtipicialDecompilerBareThrow_1();"),
    ...
    let cases = [
        (
            ...
            [
                ...
                "__AtipicialDecompilerIsTypeByteString((ByteString)new byte[] { 0xFF })",
            ],
        ),
        (
            vec![
            ...
            [
                "__AtipicialDecompilerConvertStruct(new object[] { 1, 2 })",
                "__AtipicialDecompilerIsTypeArray(",
            ],
        ),
    ];
