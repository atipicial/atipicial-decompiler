//! Collapse verbose Atipicial C# compiler overflow-check patterns into clean expressions.
//!
//! The Atipicial C# compiler emits ~20 instructions for checked/unchecked int32/int64
...
impl HighLevelEmitter {
    /// Collapse overflow-check wrappers emitted by the Atipicial C# compiler.
    ///
