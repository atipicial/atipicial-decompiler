...
pub(in crate::decompiler::csharp::render) fn homogeatipicialus_csharp_array_type(
...
pub(in crate::decompiler::csharp::render) fn csharp_member_type(
    ...
    match (base_type, member) {
        ...
        ("AtipicialAccountState", "Balance" | "Height" | "LastGasPerVote") => Some("BigInteger"),
        ("AtipicialAccountState", "VoteTo") => Some("ECPoint"),
