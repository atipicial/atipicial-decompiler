...
fn renders_all_expression_variants() {
    ...
    let cases = vec![
        ...
        (
            ...
            "__AtipicialDecompilerConvertInteger(value)",
        ),
        (
            Expr::IsType {
                value: Box::new(Expr::var("value")),
            ...
            "__AtipicialDecompilerIsTypeInteger(value)",
        ),
        (
            Expr::NewArray {
    ...
    let intrinsic_cases = [
        ...
        (
            OpCode::Append,
            2,
            "((Atipicial.SmartContract.Framework.List<object>)a).Add(b)",
        ),
        (
            OpCode::Remove,
            2,
        ...
        (
            OpCode::Popitem,
            1,
            "((Atipicial.SmartContract.Framework.List<object>)a).PopItem()",
        ),
        (
            OpCode::Memcpy,
            5,
    ...
    assert_eq!(
        ...
        "AtipicialCoin.GetCandidates(items)"
    );
    ...
    assert_eq!(
        ...
        "((Atipicial.SmartContract.Framework.List<object>)items).Add(value)"
    );
    assert_eq!(
        render_expr(
        ...
        "__AtipicialDecompilerUnresolvedCall(\"call_0x1234\", new object[] { items })"
    );
}
