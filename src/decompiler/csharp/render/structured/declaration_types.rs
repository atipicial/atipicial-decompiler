...
use super::declaration_type_catalog::{
    ...
    homogeatipicialus_csharp_array_type,
};
...
fn concrete_expression_type_with_symbols_and_known(
    ...
    match expression {
        ...
        // Atipicial treats compiler string literals as byte strings. The generated
        ...
        Expr::Binary { op, left, right } => {
            ...
            // Atipicial VM arithmetic/bitwise opcodes always yield an Integer (the
        ...
        Expr::Array(elements) => homogeatipicialus_csharp_array_type(elements.iter().map(|element| {
            concrete_expression_type_with_symbols_and_known(
                element,
                symbols,
                known_types,
