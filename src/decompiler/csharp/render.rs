//! C# skeleton renderer.
//!
//! The renderer produces a Atipicial SmartContract Framework-compatible skeleton
...
const UNPACK_PACKSTRUCT_HELPER: &str = "__AtipicialDecompilerUnpackPackStruct";
const BARE_THROW_HELPER: &str = "__AtipicialDecompilerBareThrow";
...
pub(crate) fn render_csharp(
    ...
    let patterns = identify_patterns(aef, instructions, manifest);
    ...
    header::write_contract_open(&mut output, &contract_name, aef, manifest);
