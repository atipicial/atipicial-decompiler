...
pub(super) const VM_ASSERT_MESSAGE_HELPER: &str = "__AtipicialDecompilerAssertMessage";
pub(super) const VM_EXCEPTION_TYPE: &str = "__AtipicialDecompilerVmException";
...
fn legacy_statement_to_csharp_untyped(
    ...
    // Atipicial can throw any stack value, while C# exception payloads are strings.
...
/// Atipicial.Compiler.CSharp erases these object casts, leaving the raw stack item for
...
/// Atipicial.Compiler.CSharp rewrites its framework overload to lazy JMPIF + ABORTMSG,
...
pub(super) fn format_vm_assertion(
    ...
    message.map_or_else(
        || format!("global::Atipicial.SmartContract.Framework.ExecutionEngine.Assert({condition});"),
