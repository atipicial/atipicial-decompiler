...
/// Decode a Atipicial VM StackItemType operand into the language-neutral type model.
...
/// Encode a language-neutral type as a Atipicial VM StackItemType operand byte.
