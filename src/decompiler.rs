...
//! Parses AEF, disassembles bytecode, lifts control flow, and renders text/C#.

/// Maximum file size allowed for AEF files (1 MiB).
...
/// conservative diagnostic for calls that will render directly as a Atipicial
