...
pub const NATIVE_CONTRACTS: &[NativeContractInfo] = &[
    ...
    NativeContractInfo {
        ...
        methods: &["BalanceOf", "ExpirationOf", "GetMaxNotValidBeforeDelta", "LockDepositUntil", "OnAEP17Payment", "SetMaxNotValidBeforeDelta", "Verify", "Withdraw", "_OnPayment"],
    },
    NativeContractInfo {
        name: "OracleContract",
    ...
    NativeContractInfo {
        ...
        methods: &["BalanceOf", "Decimals", "GetAccountState", "GetAllCandidates", "GetCandidateVote", "GetCandidates", "GetCommittee", "GetCommitteeAddress", "GetGasPerBlock", "GetNextBlockValidators", "GetRegisterPrice", "OnAEP17Payment", "RegisterCandidate", "SetGasPerBlock", "SetRegisterPrice", "Symbol", "TotalSupply", "Transfer", "UnclaimedGas", "UnregisterCandidate", "Vote"],
    },
    NativeContractInfo {
