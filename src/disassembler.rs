//! Stateless Atipicial VM bytecode decoder used by the decompiler and CLI.
...
/// Stateless helper that decodes Atipicial VM bytecode into structured instructions.
///
