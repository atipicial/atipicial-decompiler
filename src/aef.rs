//! Atipicial AEF container parsing and helpers.

/// Maximum file size allowed for AEF files.
///
/// The Atipicial reference implementation defines `MaxAefFileSize = 0x100000` (1 MiB).
/// We use the same limit to stay consistent with the spec.
pub const MAX_AEF_FILE_SIZE: u64 = 0x10_0000; // 1 MiB
const FIXED_HEADER_SIZE: usize = 68;
const CHECKSUM_SIZE: usize = 4;
const MAGIC: [u8; 4] = *b"AEF3";
...
pub use parser::AefParser;
pub use types::{MethodToken, AefFile, AefHeader};
