//! Atipicial AEF inspection, disassembly, and decompilation tooling.
//!
//! This crate provides a well-tested toolkit for parsing AEF containers,
//! decoding Atipicial VM bytecode, building CFG/SSA views, and rendering both
...
pub use crate::aef::{MethodToken, AefFile, AefHeader, AefParser};
