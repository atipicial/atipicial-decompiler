...
impl ManifestPermissionContract {
    ...
    /// # Examples
    /// ```
    /// use atipicial_decompiler::manifest::ManifestPermissionContract;
    ///
...
impl ManifestPermissionMethods {
    ...
    /// # Examples
    /// ```
    /// use atipicial_decompiler::manifest::ManifestPermissionMethods;
    ///
...
impl ManifestTrusts {
    ...
    ///   canonical  manifest "structured trusts" — are flattened
    ...
    /// # Examples
    /// ```
    /// use atipicial_decompiler::manifest::ManifestTrusts;
    ///
...
mod tests {
    ...
    fn structured_trusts_non_string_array_falls_back_to_raw_json() {
        ...
        //  spec — refuse to flatten and surface the raw JSON so
