...
const NATIVE_CONTRACTS = [
  ...
  },
  {
    ...
    methods: [
      ...
      "LockDepositUntil", "OnAEP17Payment", "SetMaxNotValidBeforeDelta",
  ...
  },
  {
    ...
    methods: ["OnAEP11Payment", "OnAEP17Payment", "Verify"],
  },
  {
  ...
  },
  {
    ...
    methods: [
      ...
      "GetRegisterPrice", "OnAEP17Payment", "RegisterCandidate",
...
const FRAMEWORK_METHOD_NAMES = new Map([
  ...
  ["AtipicialCoin:UnregisterCandidate", "UnRegisterCandidate"],
...
/**
 * Return the spelling used by the Atipicial C# framework for a catalogued native
...
const FRAMEWORK_SUPPORTED_METHODS = new Map([
  ...
  ["AtipicialDollar", new Set([
    "BalanceOf", "Decimals", "Symbol", "TotalSupply", "Transfer",
  ])],
  ["AtipicialCoin", new Set([
    "BalanceOf", "Decimals", "GetAccountState", "GetAllCandidates",
...
const NATIVE_METHOD_RETURN_TYPES = new Map([
  ...
  ["AtipicialDollar:Symbol", "string"],
  ["AtipicialCoin:Symbol", "string"],
  ["AtipicialDollar:Decimals", "byte"],
  ["AtipicialCoin:Decimals", "byte"],
  ["AtipicialDollar:BalanceOf", "BigInteger"],
  ["AtipicialCoin:BalanceOf", "BigInteger"],
  ["AtipicialDollar:GetGasPerBlock", "BigInteger"],
  ["AtipicialCoin:GetGasPerBlock", "BigInteger"],
  ["AtipicialDollar:TotalSupply", "BigInteger"],
  ["AtipicialCoin:TotalSupply", "BigInteger"],
  ["AtipicialDollar:UnclaimedGas", "BigInteger"],
  ["AtipicialCoin:UnclaimedGas", "BigInteger"],
  ["AtipicialDollar:Transfer", "bool"],
  ["AtipicialCoin:Transfer", "bool"],
  ["AtipicialCoin:GetRegisterPrice", "long"],
  ["AtipicialCoin:RegisterCandidate", "bool"],
  ["AtipicialCoin:UnregisterCandidate", "bool"],
  ["AtipicialCoin:Vote", "bool"],
  ["AtipicialCoin:GetCandidates", "(ECPoint, BigInteger)[]"],
  ["AtipicialCoin:GetAllCandidates", "Iterator<(ECPoint, BigInteger)>"],
  ["AtipicialCoin:GetCandidateVote", "BigInteger"],
  ["AtipicialCoin:GetCommittee", "ECPoint[]"],
  ["AtipicialCoin:GetNextBlockValidators", "ECPoint[]"],
  ["AtipicialCoin:GetCommitteeAddress", "UInt160"],
  ["AtipicialCoin:GetAccountState", "AtipicialAccountState"],
