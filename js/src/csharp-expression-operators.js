...
// Atipicial VM truthiness permits numeric and bitwise values in a NOT operation,
...
// C# requires an integral `int` shift count even when the Atipicial VM value is a
