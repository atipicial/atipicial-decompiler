...
export function buildSampleAef() {
  const script = [0x10, 0x11, 0x9e, 0x40];
  return buildAefFromScript(script);
}

export function buildAefFromScript(scriptBytes) {
...
export function buildLocalMathAef() {
  const script = [
...
export function buildAefWithSingleToken(
  scriptBytes,
  hash,
  method,
  parametersCount,
