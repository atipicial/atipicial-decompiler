#!/usr/bin/env python3
"""
Generate Rust lookup tables for Atipicial syscalls by scraping ApplicationEngine partial classes.
"""
...
LOCAL_BASE = REPO_ROOT / "atipicial_csharp" / "core" / "src" / "Atipicial" / "SmartContract"
RAW_BASE_URL = "https://raw.githubusercontent.com/atipicial-project/atipicial/master/src/Atipicial/SmartContract/"
FILES = [
...
# Derived from the Atipicial C# handler method signatures (excluding the implicit
