#!/usr/bin/env python3
"""
Generate Rust lookup tables for Atipicial native contracts and their exposed method names.
"""
...
LOCAL_NATIVE_DIR = REPO_ROOT / "atipicial_csharp" / "core" / "src" / "Atipicial" / "SmartContract" / "Native"
API_CONTENTS_URL = "https://api.github.com/repos/atipicial-project/atipicial/contents/src/Atipicial/SmartContract/Native/"
RAW_BASE_URL = "https://raw.githubusercontent.com/atipicial-project/atipicial/master/src/Atipicial/SmartContract/Native/"
...
def fetch(path: str) -> str:
    ...
    headers = {
        "User-Agent": "atipicial-decompiler/0.1",
        "Accept": "text/plain",
    }
