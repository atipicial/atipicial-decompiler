...
Run: `cd /home/atipicial/git/atipicial-decompiler/js && npm test -- --test-name-pattern "manifest|sanitize|signature"`
...
Run: `cd /home/atipicial/git/atipicial-decompiler/js && npm test -- --test-name-pattern "syscall|warning|packed-store"`
...
Run: `cd /home/atipicial/git/atipicial-decompiler/js && npm test -- --test-name-pattern "label|goto|leave|endtry"`
...
Run: `rg -n "web|wasm" /home/atipicial/git/atipicial-decompiler/js/README.md /home/atipicial/git/atipicial-decompiler/README.md`
...
Run: `cd /home/atipicial/git/atipicial-decompiler/js && npm test`
