...
**Tech Stack:** Rust, existing CFG/SSA/typed IR model, structured control-flow recovery, unit and AEF integration tests. No new dependencies or public IR variants.
