...
**Goal:** Preserve six fixed-arity Atipicial collection and buffer mutations as ordered effect statements throughout the Rust structured SSA/IR pipeline.
...
**Tech Stack:** Rust, existing Atipicial opcode model, CFG/SSA/typed IR modules, built-in unit and integration test harnesses. No new dependencies or public IR variants.
