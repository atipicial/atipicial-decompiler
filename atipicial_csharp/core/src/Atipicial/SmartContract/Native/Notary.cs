...
//
// Notary.cs file belongs to the atipicial project and is free
...
namespace Atipicial.SmartContract.Native
{
    ...
    public sealed class Notary : NativeContract
    {
        ...
        protected override void OnManifestCompose(IsHardforkEnabledDelegate hfChecker, uint blockHeight, ContractManifest manifest)
        {
            ...
            {
                manifest.SupportedStandards = ["AEP-27", "AEP-30"];
            }
            else
            {
                manifest.SupportedStandards = ["AEP-27"];
            }
        }
        ...
        /// <summary>
        /// OnAEP17Payment is a callback that accepts GAS transfer as Notary deposit.
