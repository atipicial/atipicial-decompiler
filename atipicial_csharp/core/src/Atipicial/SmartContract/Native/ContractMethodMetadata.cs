...
//
// ContractMethodMetadata.cs file belongs to the atipicial project and is free
...
using Boolean = Atipicial.VM.Types.Boolean;
using Buffer = Atipicial.VM.Types.Buffer;
