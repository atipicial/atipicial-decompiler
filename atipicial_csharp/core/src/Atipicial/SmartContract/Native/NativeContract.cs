...
//
// NativeContract.cs file belongs to the atipicial project and is free
...
namespace Atipicial.SmartContract.Native
{
    ...
    public abstract class NativeContract
    {
        ...
        /// <summary>
        /// Gets the instance of the <see cref="AtipicialCoin"/> class.
        /// </summary>
        public static AtipicialCoin ATC { get; } = new();

        /// <summary>
        /// Gets the instance of the <see cref="AtipicialDollar"/> class.
        /// </summary>
        public static AtipicialDollar GAS { get; } = new();
        ...
        {
            // Get allowed methods and aef script
        ...
        {
            var committeeMultiSigAddr = ATC.GetCommitteeAddress(engine.SnapshotCache);
        ...
        protected static UInt160 AssertAlmostFullCommittee(ApplicationEngine engine)
        {
            ...
            var committees = NativeContract.ATC.GetCommittee(engine.SnapshotCache);
