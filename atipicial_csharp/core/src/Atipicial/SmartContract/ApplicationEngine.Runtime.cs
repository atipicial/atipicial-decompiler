...
//
// ApplicationEngine.Runtime.cs file belongs to the atipicial project and is free
...
using Atipicial.SmartContract.Native;
using Atipicial.VM;
...
namespace Atipicial.SmartContract
{
    partial class ApplicationEngine
    {
        ...
        /// Burning GAS to beaefit the ATC ecosystem.
        /// </summary>
        ...
        /// Gets the name of the current platform.
        /// </summary>
        /// <returns>It always returns "ATC".</returns>
