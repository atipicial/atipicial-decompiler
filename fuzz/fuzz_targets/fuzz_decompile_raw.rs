...
use atipicial_decompiler::{optimize_ssa, structure_cfg, CfgBuilder, Disassembler, SsaBuilder};
...
fuzz_target!(|data: &[u8]| {
    ...
    // 1. Disassemble raw bytecode, bypassing AEF header validation entirely.
    ...
    // decompile of real AEFs is tiny; this only skips pathological raw scripts.
