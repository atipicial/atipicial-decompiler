...
next_action: Keep genuinely runtime-variable stack transforms fail-closed, retain conservative exceptional-only finally SSA, and rerun the full Roslyn corpus census when Atipicial.SmartContract.Framework.dll is available locally.
...
reproduction: Extract atipicial-devpack-dotnet v3.10.0 artifacts and run csharp_corpus_has_zero_structured_fallback with TestingArtifacts/devpack present.
...
- hypothesis: ENDFINALLY can be modeled as ordinary fallthrough or as a single fixed jump target encoded by the instruction.
  evidence: Atipicial VM ENDFINALLY has no operand. It pops the active ExceptionHandlingContext and either jumps to the path-specific EndPointer saved by ENDTRY/ENDTRY_L or rethrows UncaughtException; multiple ENDTRY sites may enter one finally with different targets.
...
- hypothesis: /tmp/atipicial-devpack-dotnet-audit and /tmp/devpack-artifacts-audit represent the pinned v3.10.0 release baseline.
...
- timestamp: 2026-07-12T15:27:05+08:00
  checked: Atipicial CallFlags and MethodToken validation plus CallFlagInvalid bytes.
...
- timestamp: 2026-07-12T15:27:05+08:00
  ...
  found: All 103 committed AEF and manifest pairs extract and parse without compiling upstream, but later provenance verification identified this checkout as floating master 1c2f7adc rather than v3.10.0.
...
- timestamp: 2026-07-12T16:08:00+08:00
  ...
  found: /tmp/atipicial-devpack-dotnet-audit exists and /tmp/devpack-artifacts-audit contains 206 flat files; TestingArtifacts/devpack is absent in the worktree.
...
- timestamp: 2026-07-12T16:22:00+08:00
  ...
  found: Every fallback start maps one-to-one to a method. Sixty-seven starts map directly to manifest ABI names; Contract_Returns offset 131 is the private upstream method TryReturnInternal, confirmed in tests/Atipicial.Compiler.CSharp.TestContracts/Contract_Returns.cs.
...
- timestamp: 2026-07-12T16:34:00+08:00
  checked: Atipicial VM control semantics in atipicial-vm commit 2c2be02e5067c524677d9bf74062077283e1ecd8, JumpTable.Control.cs and ExceptionHandlingContext.cs, corroborated by atipicial-devpack-dotnet v3.10.0 OpCode documentation.
...
- timestamp: 2026-07-12T16:34:00+08:00
  checked: atipicial-devpack-dotnet's own TryCatchFinallyCoverage static analyzer.
...
- timestamp: 2026-07-12T16:45:00+08:00
  ...
  found: The try body branches to CALL testAbortMsg at 46 or CALL testAbort at 48; both callees end in ABORTMSG/ABORT and never return in Atipicial VM. Nevertheless both manifest methods declare Integer, MethodContract ReturnBehavior is value (the enum has only Value/Void/Unknown), CallContract returns_value is true, apply_known_call pushes a result, and CFG construction treats every CALL as ordinary fallthrough. This creates impossible edges 46->48 and 48->the catch handler at 50.
...
- timestamp: 2026-07-12T17:02:00+08:00
  checked: Atipicial VM v3.10.0 stack-operation implementations and bounds behavior.
...
- timestamp: 2026-07-12T17:10:00+08:00
  checked: Rebuilt current CLI against every flat AEF in the floating-master /tmp/devpack-artifacts-audit corpus.
  found: All 103 floating-master AEF/manifest pairs decompile successfully (103 success, 0 errors). That floating-master structured gate reports 68 fallback method entries in 18 contracts; 85 contracts have none.
...
- timestamp: 2026-07-12T17:20:00+08:00
  checked: Exact atipicial-devpack-dotnet v3.10.0 checkout at 5b0b63880b6201ae3f974cc845e93a90462d8043 and extraction to /tmp/devpack-artifacts-v3.10.0.
  found: The pinned tag supplies 103/103 AEF and manifest pairs. Its authoritative zero-fallback gate reports 67 methods in 17 contracts: PICK 31, ROLL 2, REVERSEN 2, ENDFINALLY 31, and STLOC1 1; 86 contracts have no primary structured fallback.
  implication: These figures supersede every 68/18 count from floating master and are the release baseline.

- timestamp: 2026-07-12T17:20:00+08:00
  checked: Exact-tag dynamic scan and diagnosis-only scalar-SSA spike in /tmp/atipicial-decompiler-stack-spike-20260712.
...
- timestamp: 2026-07-13T07:05:30+08:00
  ...
  found: No Atipicial.SmartContract.Framework.dll exists under /home/atipicial, so the representative Roslyn test remains intentionally ignored; TestingArtifacts/devpack is absent after every pinned gate run.
