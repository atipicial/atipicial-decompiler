...
use crate::common::{build_sample_aef, atipicial_decompiler_cmd, SAMPLE_MANIFEST};

#[test]
fn schema_command_outputs_embedded_schema() {
    let pretty = atipicial_decompiler_cmd()
        .arg("schema")
        .arg("info")
        .output()
    ...
    assert_eq!(
        schema["title"],
        Value::String("atipicial-decompiler info report".into())
    );

    let compact = atipicial_decompiler_cmd()
        .arg("--json-compact")
        .arg("schema")
        .arg("info")
        .output()
    ...
    let list = atipicial_decompiler_cmd()
        .arg("schema")
        .arg("--list")
        .output()
        .expect("list schemas");
    ...
    let json_list = atipicial_decompiler_cmd()
        .arg("schema")
        .arg("--list-json")
        .output()
    ...
    let file_output = atipicial_decompiler_cmd()
        .arg("schema")
        .arg("info")
        .arg("--json-compact")
        .arg("--output")
    ...
    let quiet_output = atipicial_decompiler_cmd()
        .arg("schema")
        .arg("info")
        .arg("--json-compact")
        .arg("--output")
    ...
    let aef_path = dir.path().join("validation.aef");
    ...
    let info_json = atipicial_decompiler_cmd()
        .arg("--manifest")
        .arg(&manifest_path)
        .arg("info")
        .arg("--format")
    ...
    let validation = atipicial_decompiler_cmd()
        .arg("schema")
        .arg("info")
        .arg("--validate")
        .arg(&info_json_path)
    ...
    let stdin_validation = atipicial_decompiler_cmd()
        .arg("schema")
        .arg("info")
        .arg("--validate")
        .arg("-")
